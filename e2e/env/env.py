...
class Config:
    ...
    # Emm
    E_MM_CUSTOMER = os.getenv("E_MM_CUSTOMER")
    E_MM_CUSTOMER_FULL_NAME = os.getenv("E_MM_CUSTOMER_FULL_NAME")

    # Esmm
    E_SMM_E_INVOICE_CUSTOMER = os.getenv("E_SMM_E_INVOICE_CUSTOMER")
    E_SMM_E_ARCHIVE_CUSTOMER = os.getenv("E_SMM_E_ARCHIVE_CUSTOMER")
